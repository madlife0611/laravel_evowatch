...
class Products extends Model
{
    ...
    public function modelCreate(){
        ...
        //update ban ghi
        DB::table("product")->insert(["name"=>$name,"description"=>$description,"content"=>$content,"price"=>$price,"discount"=>$discount,"baohanh"=>$baohanh,"status"=>$status,"category_id"=>$category_id,"hot"=>$hot,"image"=>$image]);
    }
